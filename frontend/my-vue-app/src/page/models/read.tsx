...
import { PostTasks } from "./posts";
import { UpdateTask, UpdateTaskStatus } from "./update";
...
export default function Read() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editingTask) {
                await UpdateTask(editingTask.id, formData.title, formData.description);
                setEditingTask(null);
            } else {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-4">
                ...
                {error && (
                    <h5 className="text-red-500 text-sm mt-2">{error}</h5>
                )}
            </form>
